This folder contains code for fitting a SEIR model to epidemiological data for the COVID-19 outbreak in Ireland. A simulated annealing algorithm is used to find the best fitting parameter values.
